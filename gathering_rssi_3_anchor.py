...
mac1, mac2, mac3 = "3C:71:BF:C4:E1:F4", "3C:71:BF:88:A0:B4", "B4:E6:2D:B3:57:E5"
        ...
        if any(x is None for x in rssi):
            ...
            if bEqual:
                ...
                new_row = ['Ruang 2', datetime.now().time().replace(
                    microsecond=0), rssi[0], rssi[1], rssi[2]]

                with open('rssi_collected_3_anchor.csv', 'a', newline='') as csv_file:
                    writer = csv.writer(
