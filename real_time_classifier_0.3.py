...
url_dt = "rssi_collected_3_anchor.csv"
header_dt = ['ruang', 'time', 'sensor1','sensor2', 'sensor3']
...
mac = ["3C:71:BF:C4:E1:F4", "3C:71:BF:88:A0:B4", "B4:E6:2D:B3:57:E5", "locator"]
        ...
        if not any(x is None for x in rssi):
            ...
            if bEqual:
                ...
                if x_ds != None:
                    ...
                    if true_loc != None:
                        with open('real_time_result_3_anchor.csv', 'a', newline='') as csv_file:
                            writer = csv.writer(
